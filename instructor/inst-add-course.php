...
if(isset($_REQUEST['courseSubmitBtn'])){
  ...
  ($_REQUEST['course_orginal_price']=="") ||  ($_REQUEST['course_price']=="")){
    ...
    $sql="INSERT INTO course (course_name, course_desc, course_author,inst_email,course_img, course_duration,course_price,course_orginal_price)VALUES('$course_name', '$course_desc', '$course_author','$instLogEmail', '$img_folder', '$course_duration', '$course_price','$course_orginal_price')";
...
<div class="container">
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" id="author" name="course_author" value="<?php echo $instLogEmail  ?>" placeholder="Your author name..">
